...
1.  **`assistente.py`**: Versão clássica leve.
    *   STT: Google Speech Recognition (Online) ou Whisper Local (dependendo da configuração).
    *   TTS: pyttsx3 (Offline)
...
- `app.py`: Interface gráfica para o assistente de IA (Gradio).
- `assistente.ipynb`: Versão em notebook com Whisper local.
